  ...
  <div class="container">
    <div class="row-fluid">
			<div class="span9">
				  ...
				  <br>
				  <h3>ADSell service center</h3>
				  <p>For more information about ADSell, please free to contact us with service and media inquiries below.</p>
				  <br>
				  <div class="span4">
				  <address>
					<strong>ADSell Direct Selling <br> Service Center</strong><br>
					Cadelina Blg.,<br>
					Quezon Street, New Pandan,<br>
					Panabo City,<br>
					Davao del Norte, 8105<br>
					Philippines<br>
					<abbr title="Phone">P:</abbr> (123) 456-7890
					<br>
					<abbr title="Phone">P:</abbr> 09306673054
				  </address>
				  </div>
				  <div class="span4">
				  </div>
				  <address>
					...
					<a href="mailto:ariesmanian1990@gmail.com">ariesmanian1990@gmail.com</a><br>
					<a href="mailto:ariesmanian@yahoo.com">ariesmanian@yahoo.com</a>
				  </address>
				  <br>
				  <br>
			</div><!--/row-->
