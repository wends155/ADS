    ...
    <div class="row-fluid">
	 ...
	 <div class="span4">	
            <ul class="nav nav-list bs-docs-sidenav">
			   <li class="active"><a href="cart.php"><i class="icon-shopping-cart"></i><i class="icon-chevron-right"></i> My Cart</a></li>
	 ...
	 <div class="span8">
	   <div class="well">
		...
		<?php echo $cartTotal; ?>
		<br><br>
		<form method="POST" action=""><p class="navbar-text pull-right"><button class='btn btn-success btn-large'>Proceed to Checkout</button></p></form>
		<p class="navbar-text pull-left"><a class="btn btn-large" href="cart.php?cmd=emptycart">Click Here to Empty Your Shopping Cart</a></p>
		<br><br>
	 </div>
	</div>
   </div> <!-- /.row -->
