...
//check for existence
	if($fullname&&$username&&$password&&$confirmpassword&&$street&&$city&&$province&&$cnum&&$gender&&$nationality&&$bio&&$status)
	{
		if ($password==$confirmpassword)
		{
				...
				$pid = mysql_insert_id();
				$newname = "$pid.jpg";
				move_uploaded_file( $_FILES['fileField']['tmp_name'], "/user/user_image/$newname");
				die ("<div class='span6'>	  
...
<div class="span12">
  <div class="well sidebar-nav">
   <form class="form-horizontal" action="register.php" id="contact-form" method="POST">
		  ...
		  <!-- CAPTCHA HERE  -->
		  <div class="control-group">
		    <label class="control-label" for="input01">Captcha Here:&nbsp;</label>
			<img src="db_con/captcha.php" id="captcha" />&nbsp;
				<a href="#" onclick="
					document.getElementById('captcha').src='db_con/captcha.php?'+Math.random();
					document.getElementById('captcha-form').focus();"
					id="change-image">Not readable? Change text.
				</a>
		  </div>
		  <div class="control-group">
		    <label class="control-label" for="input01">Test:</label>
			<div class="controls">
